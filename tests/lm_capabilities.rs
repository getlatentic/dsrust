...
#[test]
fn a_configured_model_answers_for_the_reference_it_was_built_from() {
        ...
        [("openai/gpt-4o", true), ("anthropic/claude-2.1", false), ("ollama/llama3.2", false)]
    {
        ...
        assert_eq!(lm.capabilities().function_calling, function_calling, "{reference}");
    }
}
...
#[test]
fn a_model_that_says_nothing_grants_nothing() {
    struct Silent;
    ...
    assert_eq!(Silent.capabilities(), Capabilities::default());
}

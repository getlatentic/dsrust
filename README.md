...
Two layers, both against the pinned upstream (`dspy==3.3.0`, `gepa==0.1.1`, `optuna==4.9.0`),
...
Today: **1676 Rust tests pass**, and **1215 of DSPy's own**, across 69 of its 94 test files. 730 of those cross into the Rust crate.
...
- [ ] **dspy 3.3.1**: the pin moves, and with it the XML adapter's nested output, the interpreter's
  hardening, the compile and interpreter callback points, and gepa 0.1.4's proposal strategies.

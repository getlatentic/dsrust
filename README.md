...
- **Watch a run with the tracing you already have.** All six of DSPy's callback points are spans —
  module, model call, tool, prompt rendering, reply parsing, evaluation — nested as the program is
  nested. `RUST_LOG=dsrust::observe=info` and nothing else.
...
Today: **1002 Rust tests pass**, and **897 of DSPy's own**, across 52 of its 86 test files. 479 of those cross into the Rust crate.

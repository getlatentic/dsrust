    ...
    pub async fn compile_traced(
        ...
        crate::observe::compiling(
            ...
            async move {
                ...
                let advisor =
                    crate::predict::Predict::from_signature(super::feedback::offer_feedback());
                ...
                for _ in 0..self.max_steps {
                    ...
                    let batch: Vec<Example> =
                        step.batch.iter().map(|at| trainset[*at].clone()).collect();
                    ...
                    for bucket in &buckets {
                        ...
                        let held = student
                            ...
                            .unwrap_or(0);
                        let dropped =
                            search::demos_to_drop(&mut rng, &mut numpy, held, self.max_demos);
                        for predictor in student.named_predictors() {
                            let mut at = 0;
                        ...
                        let strategy =
                            self.strategies()[rng.choice_index(self.strategies().len())].clone();

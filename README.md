...
Today: **970 Rust tests pass**, and **897 of DSPy's own**, across 52 of its 86 test files. 479 of those cross into the Rust crate.
...
- [ ] **`lm.call(…)`**: reaching a model directly, without a signature — DSPy's `BaseLM.__call__`.
